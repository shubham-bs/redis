...
class DecrConcurrencyTest {

    @Test
    void concurrentDecrements() throws InterruptedException {
        DataStore store = new DataStore();
        store.set("counter", new RedisString("0"));
        ...
        long finalValue = Long.parseLong(result.value());
